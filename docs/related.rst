...
documentation the developers found usefulwhen creating |M4OPT| and other
...
.. _`International Workshops on Planning and Scheduling for Space (IWPSS)`:
https://sites.google.com/view/iwpss/
