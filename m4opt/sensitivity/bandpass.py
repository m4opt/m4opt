...
# TODO: Should we merge this with PhotonSource? it has essentially the same
# features except it uses Spectral Element instead of SourceSpectrum
...
class Bandpass(Model):
    ...
    ----------
    name : string
        Name of object. Used for accessing internal parameters
        in compound background model.
